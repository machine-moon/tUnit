...
void test_string_evaluators() {
  ...
  test.expect("String Evaluator use(world, wo)",
              string_eval.use(std::string("world"), std::string("wo")), true);
  test.expect("String Evaluator compare(bye)",
              string_eval.compare(std::string("bye")), false);
}
