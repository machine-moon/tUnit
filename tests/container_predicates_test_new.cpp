...
int main()
{
    auto& suite = TestRunner::get_suite("Container Predicates");
    ...
    suite.test("mixed_numbers not exactly 3 satisfy even", [&](){ 
    ...
    suite.test("mixed_numbers fails at_least 5 satisfy even", [&](){ 
    ...
    suite.test("mixed_numbers fails at_most 1 satisfy even", [&](){ 
