...
int main()
{
    auto& suite = TestRunner::get_suite("Common Predicates");
    ...
    // Range predicates (3-arg predicates in lambda wrapping)
    suite.test("5 is_in_range 1-10", [](){ return pred::is_in_range{}(5, 1, 10); }());
    suite.test("15 is_out_of_range 1-10", [](){ return pred::is_out_of_range{}(15, 1, 10); }());
    suite.test("0 is_in_range 0-10", [](){ return pred::is_in_range{}(0, 0, 10); }());
    suite.test("-5 is_out_of_range 1-10", [](){ return pred::is_out_of_range{}(-5, 1, 10); }());
    ...
    suite.test("-5 is_negative", [](){ return pred::is_negative{}(-5); }());
    suite.test("0 is_zero", [](){ return pred::is_zero{}(0); }());
    ...
    suite.test("0 is_even", [](){ return pred::is_even{}(0); }());
    suite.test("-4 is_even", [](){ return pred::is_even{}(-4); }());
    suite.test("Large number is_positive", [](){ return pred::is_positive{}(1000000); }());
    suite.test("3 is_not_even", [](){ return pred::is_even{}(3); }(), false);
    suite.test("4 is_not_odd", [](){ return pred::is_odd{}(4); }(), false);
    suite.test("-1 is_not_positive", [](){ return pred::is_positive{}(-1); }(), false);
